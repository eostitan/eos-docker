...
COPY /eosiofiles/nodeos /usr/local/bin/nodeos
COPY /eosiofiles/eosio-blocklog /usr/local/bin/eosio-blocklog
COPY /eosiofiles/keosd /usr/local/bin/keosd
COPY /eosiofiles/cleos /usr/local/bin/cleos
COPY /eosiofiles/trace_api_util /usr/local/bin/trace_api_util
